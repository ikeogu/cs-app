                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a type="button" class="dropdown-item btn btn-info"
                                                        data-toggle="modal"
                                                        data-target="#creditModal-{{ $key }}">Credit</a>
                                                    ...
                                                    <a class="dropdown-item btn btn-danger"
                                                        href="{{route('MCT', [$item->user->id]) }}" >More</a>
                                                </div>

                                            </div>
                                        </td>
                                         <!--Credit  Modal -->
                                                <div class="modal fade" id="creditModal-{{ $key }}" tabindex="-1"
                                                    role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Credit Monthly Contributions
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" action="{{ route('credit',[$item->id]) }}">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-9">
                                                                     ...
                                                                     <div class="row">
                                                                        <div class="col-md-9">
                                                                            <div class="form-group">
                                                                                <label>Reciept ID/ trnx ID</label>
                                                                                <input type="number"
                                                                                    placeholder="Reciept ID/ trnx ID"
                                                                                    class="form-control form-control-alternative"
                                                                                    name="reciept" />
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-success">Credit</button>
                                                                </form>
                                                            </div>
                                                            <div class="modal-footer">
