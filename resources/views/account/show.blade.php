@extends('layouts.app', ['title' => __('Account Profile')])

@section('content')
    @include('users.partials.header', [
    'title' => __('Hello') . ' '. auth()->user()->name,
    'description' => __('This is your account page. '),
    'class' => 'col-lg-7'
    ])
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a href="#" class="btn btn-sm btn-info mr-4" data-toggle="modal"
                                data-target="#exampleModal1">{{ __('Withdraw') }}</a>
                            <a href="#" class="btn btn-sm btn-default float-right" data-toggle="modal"
                                data-target="#exampleModal2">{{ __('Loan') }}</a>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Account Number -') }} {{ $acct->acct_number }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Balance - ') }} {{ $acct->acct_bal }}
                            </div>
                            {{-- <div>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="tel" name="phone" id="input-email"
                                ...
                                <div class="form-group{{ $errors->has('salary') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-salary">{{ __('Salary') }}</label>
                                    <input type="number" name="salary" id="input-salary"
                                        class="form-control form-control-alternative{{ $errors->has('salary') ? ' is-invalid' : '' }}"
                                ...
                                <div class="form-group{{ $errors->has('can_pay') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                        for="input-email">{{ __('(%) You can pay!') }}</label>
                                    <input type="number" name="can_pay" id="input-can_pay"
                                        class="form-control form-control-alternative{{ $errors->has('can_pay') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('7%') }}"
                                        value="{{ old('can_pay', auth()->user()->can_pay) }}" required>

                                    @if ($errors->has('can_Pay'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('can_pay') }}</strong>
                                        </span>
                                    @endif
                                </div>
