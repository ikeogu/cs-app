...
<html>
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
        <div class="time-logo">
                <img src="{{asset('assets/img/logo.png')}}" height="99" width="auto">
        </div>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your account has been created successfully as a memberof our coperative.</p>
                            ...
                            <p> Welcome on board</p>
                                ...
                                <ul>
                                    <li> <p>Email : <strong>{{$data['email']}}</strong></p></li>
                                     <li> <p>Password : <strong>{{$data['password']}}</strong></p></li>
                                      <li><p>Unique ID : <strong>{{$data['code']}}</strong></p></li>
                                       <li> <p>Account Number : <strong>{{$data['acct_no']}}</strong></p></li>
                                        <li><p>Account Balance : <strong>{{$data['acct_bal']}}</strong></p></li>
                                         <li> <p>Shares : <strong>{{$data['shares']}}</strong></p>
